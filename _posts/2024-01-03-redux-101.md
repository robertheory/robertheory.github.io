...
Agora o componente `MovieCard` é capaz e favoritar os filmes e nossa página de favoritos irá exibi-los, aparentemente está tudo funcionando, mas existe um pequeno problema: _Estados React são reiniciados quando a tela atualiza_.
...
NextJS é executado no lado do cliente e no lado do servidor, e no lado do servidor _NÃO EXISTE WEB STORAGE_!
